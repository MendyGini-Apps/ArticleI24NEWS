...
extension ArticleViewController
{
    private func addWebView()
    {
        ...
        heightWebViewConstraint = webView.heightAnchor.constraint(equalToConstant: 50.0)
    ...
    private func configureView()
    {
        ...
        categoryLabel.text = article.category.uppercased(with: VersionManager.sharedInstance().languageLocale)
